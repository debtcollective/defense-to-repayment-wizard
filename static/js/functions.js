...
(function($){
    ...
    $(document).ready(function (){
        ...
        $(".file input[type='file']").on("change", function() {
            ...
            $(this).valid();
            $(this).closest(".file").find("input[type='text']").val($(this).val().replace("C:\\fakepath\\", ""));
            $(this).closest(".file").find(".clear").removeClass("off");
        });

        $(".file .clear").click( function() {
            $(this).closest(".file").find("input").val("");
            $(this).closest(".file").find("input[type='file']").valid();
        });
        ...
        // validate file size: less than 2mb each
        $.validator.addMethod(
            "maxfilesize",
            function (value, element) {
                return this.optional(element) || (element.files && element.files[0] && element.files[0].size < 1024 * 1024 * 2);
            },
        ...
        $("form").validate({
            ...
            errorPlacement: function(error, element) {
                if (element.attr("type") == "radio" || element.attr("type") == "checkbox" )
                    ...
                    error.appendTo(element.closest(".file"));
